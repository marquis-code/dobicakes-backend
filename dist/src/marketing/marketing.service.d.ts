...
export declare class MarketingService {
    ...
    constructor(promoModel: Model<Promo>, bannerModel: Model<Banner>, templateModel: Model<EmailTemplate>, campaignModel: Model<EmailCampaign>, resendService: ResendService);
