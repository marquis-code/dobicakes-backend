...
let MarketingService = class MarketingService {
    ...
    subscriptionModel;
    resendService;
    constructor(promoModel, bannerModel, templateModel, campaignModel, subscriptionModel, resendService) {
    ...
    async subscribe(email, source) {
        return this.subscriptionModel.findOneAndUpdate({ email }, { email, source, isActive: true }, { upsert: true, new: true });
    }
